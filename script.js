var gl = c.getContext("webgl", { preserveDrawingBuffer: true }),
  ...
  opts = {
    ...
    shardFireworkVelMultiplier: 0.2,
...
BigFirework.prototype.reset = function () {
...
BigFirework.prototype.step = function () {
  if (this.mode === 0) {
    var ph = this.hue,
      px = this.x,
      py = this.y;
...
function anim() {
  ...
  if (fireworks.length < opts.fireworks) fireworks.push(new BigFirework());
...
const fireworkStartAudio = new Audio("./audio/firework-start.mp3");
